...
<?php $__env->startSection('header', 'Kelola Link Galeri'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sticky top-28">
                ...
                <form action="<?php echo e(route('gallery.store')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <div>
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    <td class="px-6 py-4 font-bold text-gray-900">
                                        <?php echo e(\Carbon\Carbon::parse($link->photo_date)->format('d F Y')); ?>

                                    </td>
                                    <td class="px-6 py-4">
                                        <a href="<?php echo e($link->drive_url); ?>" target="_blank" class="text-primary hover:underline truncate max-w-[200px] block">
                                            <?php echo e($link->drive_url); ?>

                                        </a>
                                    </td>
                                    <td class="px-6 py-4 text-right">
                                        <form action="<?php echo e(route('gallery.destroy', $link)); ?>" method="POST" onsubmit="return confirm('Hapus link tanggal ini?');" class="inline-block">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ARHAN\PERTIG\resources\views/admin/gallery/index.blade.php ENDPATH**/ ?>