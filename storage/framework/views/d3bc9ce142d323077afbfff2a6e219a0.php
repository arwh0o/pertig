...
<header class="fixed top-0 z-50 w-full transition-all duration-300 bg-black/20 backdrop-blur-sm border-b border-white/10" id="navbar">
    <div class="max-w-[1400px] mx-auto flex items-center justify-between px-6 md:px-8 py-4 md:py-6">
        <div class="flex items-center gap-3">
            <img src="<?php echo e(asset('logo/perti.png')); ?>" alt="Pertigaan Logo" class="h-12 md:h-14 w-auto object-contain drop-shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-16">
            <div class="flex flex-col gap-8">
                ...
                <div class="flex flex-col gap-6">
                    <?php $__empty_1 = true; $__currentLoopData = $coffees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex justify-between items-end border-b border-dashed border-gray-600 pb-2">
                        <div>
                            <h4 class="font-bold text-lg"><?php echo e($menu->name); ?></h4>
                            <p class="text-xs text-gray-400"><?php echo e($menu->description); ?></p>
                        </div>
                        <span class="text-primary font-bold text-xl">Rp <?php echo e(number_format($menu->price, 0, ',', '.')); ?></span>
                    </div>
            ...
            <div class="flex flex-col gap-8">
                ...
                <div class="flex flex-col gap-6">
                    <?php $__empty_1 = true; $__currentLoopData = $nonCoffees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex justify-between items-end border-b border-dashed border-gray-600 pb-2">
                        <div>
                            <h4 class="font-bold text-lg"><?php echo e($menu->name); ?></h4>
                            <p class="text-xs text-gray-400"><?php echo e($menu->description); ?></p>
            ...
            <div class="flex flex-col gap-8">
                ...
                <div class="flex flex-col gap-6">
                    <?php $__empty_1 = true; $__currentLoopData = $snacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex justify-between items-end border-b border-dashed border-gray-600 pb-2">
                        <div>
                            <h4 class="font-bold text-lg"><?php echo e($menu->name); ?></h4>
                            <p class="text-xs text-gray-400"><?php echo e($menu->description); ?></p>
    ...
    <div class="max-w-[1000px] mx-auto relative z-10">
        ...
        <div class="bg-[#221910] border border-[#3d2e21] rounded-3xl p-8 shadow-2xl">
            <div class="flex justify-between items-center mb-8 border-b border-[#3d2e21] pb-6">
                <h3 class="text-2xl font-bold text-white uppercase tracking-wider"><?php echo e($currentMonth->format('F Y')); ?></h3>
            ...
            <div class="grid grid-cols-7 gap-2 md:gap-4 mb-2 text-center">
                <?php $__currentLoopData = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="text-gray-500 font-bold text-xs uppercase tracking-widest"><?php echo e($day); ?></div>
            ...
            <div class="grid grid-cols-7 gap-2 md:gap-4">
                ...
                <?php for($day = 1; $day <= $daysInMonth; $day++): ?>
                    ...
                    <?php if($hasLink): ?>
                        <a href="<?php echo e($linkUrl); ?>" target="_blank" class="aspect-square bg-primary hover:bg-white hover:text-primary text-white rounded-xl flex items-center justify-center font-black text-lg transition-all transform hover:scale-110 shadow-lg shadow-primary/20 group relative cursor-pointer">
                            <?php echo e($day); ?>
...
<section class="py-24 px-6 bg-[#f0edea] dark:bg-[#1a140f] relative" id="feedback">
    ...
    <div class="max-w-[750px] mx-auto text-center relative z-10">
        ...
        <form action="<?php echo e(route('feedback.store')); ?>" method="POST" class="flex flex-col gap-6 text-left bg-white dark:bg-[#221910] p-10 rounded-3xl shadow-2xl border border-[#e7dbcf] dark:border-[#3d2e21]">
            <?php echo csrf_field(); ?>
...
<footer class="bg-background-light dark:bg-background-dark py-16 px-6 border-t border-[#f3ede7] dark:border-[#3d2e21]">
    <div class="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
        <div class="flex items-center gap-4">
            <img src="<?php echo e(asset('logo/perti.png')); ?>" alt="Pertigaan Logo" class="h-10 w-auto object-contain drop-shadow-md">
        ...
        <div class="flex flex-col md:flex-row items-center gap-6">
            ...
            <a href="<?php echo e(route('login')); ?>" class="text-xs text-gray-600 hover:text-primary transition-colors font-bold uppercase tracking-widest">Admin Login</a>
        </div>
    </div>
</footer>

</body></html>
<?php /**PATH D:\ARHAN\PERTIG\resources\views/welcome.blade.php ENDPATH**/ ?>